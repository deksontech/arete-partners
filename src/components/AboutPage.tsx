...
type IconName =
  ...
  | "star" | "cycle" | "chip" | "flag" | "monitor" | "gauge" | "mountainFlag";
        ...
        <div className="about-purpose-spec__upper">
          <div className="about-purpose-spec__main">
            ...
            <div className="about-purpose-spec__mountain" aria-label="Execution path from people to performance">
              <svg className="about-purpose-spec__path" viewBox="0 0 660 520" preserveAspectRatio="none" aria-hidden="true"><path d="M54 474 C135 462 165 425 205 410 S280 349 336 322 S405 226 467 190 S540 90 603 58" /></svg>
              {([[
                "people", "People"
              ...
              <span className="about-purpose-spec__flag"><AboutIcon name="flag" /></span>
            </div>
          </div>
